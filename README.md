...
To change language model, download the desired language model at https://sourceforge.net/projects/cmusphinx/files/Acoustic and Language Models/ and change the paths to 
